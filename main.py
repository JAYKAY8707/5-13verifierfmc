...
<body>
  <nav>
    <div class="nav-logo">
      <img src="/static/Logo large no bg tc.png" alt="First MedCare Logo" class="nav-logo-img">
      <div class="nav-links">
        <a href="/">Home</a>
  ...
  <div class="hero">
    <img src="/static/Logo large no bg tc.png" alt="First MedCare Logo" class="hero-logo">
...
<body>
  ...
  <div class="container">
    ...
    <div class="search-container">
      ...
      <div id="doctorSearch" class="search-box" style="display: none;"><div class="doctor-grid">
            {% for doc in doctors %}
